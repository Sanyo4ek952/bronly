...
type ReferralsErrorProps = {
  reset: () => void;
};

export default function ReferralsError({ reset }: ReferralsErrorProps) {
  return (
    <Panel className="grid justify-items-start gap-[14px] p-6 shadow-[var(--shadow-md)] max-[640px]:p-4" role="alert">
      ...
      <div className="grid gap-2">
        <h1 className="text-xl font-bold leading-[1.15] text-[var(--text)]">Не удалось загрузить приглашения</h1>
