        ...
        <div className="br-auth-shell__grid">
          <div className="br-auth-shell__intro">
            ...
            <p className="br-auth-shell__text">
              Запустите свою витрину, добавьте объект, номера и начните принимать заявки по
              персональной ссылке.
            </p>
          </div>
          ...
          <div className="br-auth-panel">
            ...
            <form className="br-auth-form" action={signUpAction}>
              ...
              <div className="br-auth-form__field">
                ...
                <select id="role" name="role" className="br-field" defaultValue="owner">
              ...
              <div className="br-auth-form__field">
                ...
                <input id="register-password" name="password" type="password" className="br-field" placeholder="Минимум 8 символов" required />
              </div>
