...
- `RoomPhotoCarousel` — `src/widgets/room-detail-page/room-photo-carousel.tsx` — переиспользуемая галерея; `variant="public"` ограничивает пропорции фотографий на публичных страницах.
